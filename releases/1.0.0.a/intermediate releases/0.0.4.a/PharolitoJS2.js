...
KW_left, arrow = 37, KW_up_arrow = 38, KW_right_arrow = 39, KW_down_arrow = 40,
		KW_insert = 45, KW_delete = 46, KW_left_window = 91,
		KW_right_window = 92, KW_select = 93;
	...
	function update() {
		for ( var index = 0; index < objects.length; index++) {
			...
			for ( var index = 0; index < paramNames.length; index++) {
				params.push(updateParameters[paramNames[index]]);
			}
